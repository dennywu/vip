...
<html>
    <head>	
		...
		<title>Edit Merchant :: VIP Indonesia</title>
		...
		<script type="text/javascript" src="js/editMerchant.js"></script>
    ...
    <body>
		...
		?>
		<input type='hidden' id="merchantId" value="<?php echo $merchant['id']; ?>"/>
			...
			<div class="table-responsive" id='content'>
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
						<form role="form" action="#" method="post" id='form-edit-merchant' novalidate enctype="multipart/form-data">
